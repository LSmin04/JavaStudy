public class VariableEx {
  public static void main(String[] args) {
    ...
    int b = 31;
    long c = 10000000000L;
    double d = 1.0; // double d = 1; 하면 자동 형 변환됨
    char e = 'A';
    ...
    // 강제 형 변환
    System.out.println("강제 형 변환  int -> byte 변환");  
    ...
    // double -> long 변환
    System.out.println("강제 형 변환  double -> long 변환");  
    double dd = 1.9;
    ...
    // int -> char 변환
    System.out.println("강제 형 변환  int -> char 변환");  
